...
const AgendaList = () => {
    ...
    const agendaData = Array.from({ length: 10 }, (_, i) => {
        const date = new Date(2023, 11, 15 - i); // Generating dates
        return {
            id: i + 1,
            subject: `Agenda - ${i + 1}`,
        ...
        <div className="flex h-screen bg-background">
            ...
            <main className="flex-1 p-6 bg-gray-900 overflow-y-auto">
                <header className="flex items-center justify-between mb-8">
                    ...
                    // onClick={() => navigate('/dashboard/agenda/new')} 
                    >
                ...
                <div className="space-y-4">
                    {agendaData.map((item) => {
                        ...
                        return (
                            <a
                                key={item.id}
                                onClick={() => navigate(`/dashboard/agenda/${item.id}`)}
